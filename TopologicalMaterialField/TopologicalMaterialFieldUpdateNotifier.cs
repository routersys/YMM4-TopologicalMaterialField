...
internal static class TopologicalMaterialFieldUpdateNotifier
{
    private const string Owner = "routersys";
    private const string Repository = "YMM4-TopologicalMaterialField";
    ...
    private static async Task RunAsync()
    {
        try
        {
            ...
            {
                CurrentVersion = PluginVersion.FromAssemblyInformationalVersion(typeof(TopologicalMaterialFieldUpdateNotifier)),
    ...
    private static Task ShowNotificationAsync(UpdateNotification notification, CancellationToken cancellationToken)
    {
        ...
        return application.Dispatcher.InvokeAsync(() =>
            MessageBox.Show(notification.Message, Texts.TopologicalMaterialField, MessageBoxButton.OK, MessageBoxImage.Information)).Task;
    }
}
